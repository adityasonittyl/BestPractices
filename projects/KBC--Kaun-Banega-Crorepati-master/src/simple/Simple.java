		...
		try {
			...
			if (Logo % 3 == 0) {
				...
				System.out
						.println("\t\t     [@]                                                                  [@] ");
				System.out
						.println("\t\t     [@]  K K      K K    BBBBBBBBBBBBBBBBBBBBB     CCCCCCCCCCCCCCCCCCCC  [@] ");
				System.out
						.println("\t\t     [@]  K K     K K     B BBBBBBBBBBBBBBBBB B     C CCCCCCCCCCCCCCCCCC  [@] ");
				System.out
						.println("\t\t     [@]  K K    K K      B B               B B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K K   K K       B B               B B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K K  K K        B B               B B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K K K K         B B               B B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K KK K          B BBBBBBBBBBBBBBBBB B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K   K           B BBBBBBBBBBBBBBBBB B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K KK K          B B               B B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K K K K         B B               B B     C C                   [@] ");
				System.out
						.println("\t\t     [@]  K K  K K        B B               B B     C C                   [@] ");
			...
			if (enter == 1) {
				...
				int sc = statement
						.executeUpdate("update score set score=0 where name like '" + sname + "' && age=" + age + ";");
				...
				if (age < 100) {
					...
					if (fq % 3 == 1) {
						System.out.println("Arrange these words in the correct order to form a Hindi Proverbâ€“");
						...
						System.out.println(
								"Starting with the earliest, arrange the following events in Narendra Modiâ€™s life in chronological order.");
					...
					move: {
						...
						if (change % 2 == 0) {
							...
							System.out.println(
									"Which of the following name means â€œPerson of long age â€œ?                               \t\t|-----------Lifeline------------|");
							System.out.println(
							...
							System.out.println("\t\t\t\t\t\t|your Question for Rs 5000 is |");
							System.out.println(
									"In the game of ludo the discs or tokens are of how many colours? â€œ?                    \t\t|-----------Lifeline------------|");
							System.out.println(
					...
					move3: {
						...
						if (change % 2 == 1) {
							...
							System.out.println(
									"According to a TV ad, Which duo goes to the tailor and says ,â€œMasterji, pitaji ki patloon ek bilang chhoti kar doâ€� ?\t\t|-----------Lifeline------------|");
							System.out.println(
									"(A) Hari â€“ Harish                             (B) Ramesh â€“ Suresh                                                   \t\t|Type lifeline\t\t\t|");
							System.out.println(
									"                                                                                                                    \t\t|-------------------------------|");
							System.out.println("(C) Santa â€“ Banta                             (D) Ajay â€“ Vijay");
						} else {
							System.out.println("\t\t\t\t\t\t _______________________________");
							System.out.println("\t\t\t\t\t\t|your Question for Rs 40,000 is |");
							System.out.println(
						...
						case "b":
						case "B":
							int sc1 = statement.executeUpdate(
									"update score set score=80000 where name like '" + sname + "' && age=" + age + ";");
						...
						case "lifeline":
							...
							case "B":
								...
								sc1 = statement.executeUpdate("update score set score=40000 where name like '" + sname
										+ "' && age=" + age + ";");
								System.out.println("yes you are right you won Rs.40,000");
								Thread.sleep(1600);
								System.out.println("\nYour next question for Rs.80,000");
							...
							case "lifeline":
								...
								case "b":
								case "B":
									sc1 = statement.executeUpdate("update score set score=40000 where name like '"
											+ sname + "' && age=" + age + ";");
									System.out.println("yes you are right you won Rs.40,000");
									Thread.sleep(1600);
									System.out.println("\nYour next question for Rs.80,000");
					...
					move4: {
						...
						if (change % 2 == 1) {
							...
							System.out.println(
									"People from which of these professions are most likely to use â€˜aariâ€™, â€˜basulaâ€™ and â€˜burmaâ€™ at their work?\t\t|-----------Lifeline------------|");
							System.out.println(
					...
					move4: {
						...
						if (change % 2 == 1) {
							...
							System.out.println("\t\t\t\t\t\t|your Question for Rs 6,40,000 is |");
							System.out.println(
									"According to the song from â€˜Sholayâ€™, â€œKoi Haseena Jab Rooth Jaati Hai, Toh Aur Bhi_____________ â€� ? \t\t|-----------Lifeline------------|");
							System.out.println(
						...
						case "d":
						case "D":
							int sc2 = statement.executeUpdate("update score set score=640000 where name like '" + sname
									+ "' && age=" + age + ";");
						...
						case "lifeline":
							...
							case "d":
							case "D":
								sc2 = statement.executeUpdate("update score set score=640000 where name like '" + sname
										+ "' && age=" + age + ";");
								System.out.println("yes you are right you won Rs.6,40,000");
								Thread.sleep(1600);
								System.out.println("\nYour next question for Rs.12,50,000");
							...
							case "lifeline":
								...
								case "d":
								case "D":
									sc2 = statement.executeUpdate("update score set score=640000 where name like '"
											+ sname + "' && age=" + age + ";");
									System.out.println("yes you are right you won Rs.6,40,000");
									Thread.sleep(1600);
									System.out.println("\nYour next question for Rs.12,50,000");
					...
					move4: {
						...
						System.out.println(
								"Who was the first Indian to be President of UN General assembly ?                     \t\t|-----------Lifeline------------|");
						System.out.println(
								"(A) Mrs. Vijay Lakshmi Pandit          (B) Ramesh Bhandari                            \t\t|Type lifeline\t\t\t|");
						System.out.println(
								"                                                                                      \t\t|-------------------------------|");
						...
						case "a":
						case "A":
							int sc3 = statement.executeUpdate("update score set score=10000000 where name like '"
									+ sname + "' && age=" + age + ";");
						...
						case "lifeline":
							...
							case "a":
							case "A":
								sc3 = statement.executeUpdate("update score set score=10000000 where name like '"
										+ sname + "' && age=" + age + ";");
								System.out.println("yes you are right you won Rs.1 Crore");
								Thread.sleep(1600);
								System.out.println("\nYour next question for Rs.3 Crore");
					...
					move4: {
						...
						System.out.println(
								"Which Indian Scientist has had the distinction of receiving not only the Nobel Prize, but also Bharat Ratna ?\t\t|-----------Lifeline------------|");
						System.out.println(
								"(A) Dr. Mitali Mukherjee                       (B) A.P.J Abdul Kalam                                         \t\t|Type lifeline\t\t\t|");
						System.out.println(
								"                                                                                                             \t\t|-------------------------------|");
					...
					move4: {
						...
						System.out.println(
								" Who was the Indian who won the gold medal for the first time in Olympic in shooting event.     \t\t|-----------Lifeline------------|");
						System.out.println(
								"(A) K.D. Jadhav                        (B) Major Rajyawardhan Rathor                            \t\t|Type lifeline\t\t\t|");
						System.out.println(
								"                                                                                                \t\t|-------------------------------|");
					...
					move4: {
						...
						case "a":
						case "A":
							int sc4 = statement.executeUpdate("update score set score=70000000 where name like '"
									+ sname + "' && age=" + age + ";");
						...
						case "lifeline":
							...
							case "a":
							case "A":
								sc4 = statement.executeUpdate("update score set score=70000000 where name like '"
										+ sname + "' && age=" + age + ";");
								System.out.println("yes you are right you won Rs.7 Crore\n");
								Thread.sleep(5000);
								for (int asd = 1; asd <= 100; asd++) {
				...
				if (part % 2 == 0) {
					...
					if (perm % 3 == 0) {
						...
						System.out.println(
								"Name of the player of Indian cricket team who 4 january 2013 was named as CEAT International Cricketer of the year 2012 ?");
					...
					if (perm % 3 == 0) {
						...
						System.out.println(
								"Name the Cricketer who has became the youngest Batsman to score  10000 Runs in test Cricket ?");
				...
				// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					...
					if (perm % 3 == 0) {
						...
						default:
							System.out.println(
									"you are wrong C.Elected member of legistative assembly is right Asnswer ");
							Thread.sleep(1500);
						}
					} else if (perm % 3 == 2) {
						System.out.println("The first women in space was ?");
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				System.out.println(
						"|4. To Become Winner you have to give the right answer of 15 Question                  |");
				System.out.println(
				...
				System.out.println(
						"|6. You have 7 Lifeline but each Lifeline can works only one Time.                     |");
				System.out.println(
						" --------------------------------------------------------------------------------------\n");
				...
				System.out.println(
						" --------------------------------------------------------------------------------------");
				System.out.println(
						"|1. Practise zone is same as play but the difference was that if you give wrong answer |");
				System.out.println(
						"|then program does not stop .They will move to next question                           |");
				System.out.println(
						"|2.You can give your answer any time(because timer is not present)                     |");
				System.out.println(
						"|3.It contains different parts Each part contain 10 question                           |");
				System.out.println(
						"|4.You have to give answer without using lifeline(lifeline is not added)               |");
				System.out.println(
						"|5.It is created for practise work and inceasing knowledge                             |");
				System.out.println(
						" --------------------------------------------------------------------------------------\n");
				...
				System.out.println(
						" --------------------------------------------------------------------------------------");
				System.out.println(
						"|1. In Menu option select fourth option                                                 |");
				System.out.println(
						"|2. Then you will easily able to view the name and age of the highscorer and            |");
				System.out.println(
						"|you are can easily view high score                                                     |");
				System.out.println(
						" --------------------------------------------------------------------------------------\n");
				Thread.sleep(15000);
				...
				ResultSet Res = statement
						.executeQuery("select * from score where name like'" + yourname + "' && age=" + yourage + ";");
				System.out
						.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
				while (Res.next()) {

					System.out.println(" Name =>" + Res.getString(2) + "    Age  =>" + Res.getInt(3) + " Total Earn=>"
							+ Res.getInt(4));
				...
				try {
					...
					if (lifeline == 1) {
						...
						if (fq == 1) {
							System.out.println("Flip the Question");
							System.out.println(
									"In Cricket, â€œround the wicketâ€� and â€œover the wicketâ€� represent what ?");
