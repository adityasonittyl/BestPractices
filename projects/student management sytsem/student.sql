...
insert  into `notice`(`id`,`date`,`course`,`branch`,`notice`,`uploaded_by`) values (1,'Thu Aug 25 19:04:40 IST 2016','BAC','ARCH.','exam date disclosed!!','123');
...
insert  into `student_registration`(`enrollment`,`name`,`roll`,`dob`,`gender`,`mobile`,`email`,`branch`,`course`,`sem`,`dateofjoining`,`address`,`password`) values ('00/44444','abhishek','1','3/12/2010','Male','9090909090','abhishek.roadaheadtech@gmail.com','IT','BTECH',1,'1/1/2010','vikas marg,jaipur	','rat123'),('22/3333','adfadf','2','66/66/6666','male','898989898','a@gmail.com','it','mtech',2,'5/5/5555','jaipur','kuchbhi');
