...
public class password_dialog_foruser extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public password_dialog_foruser(String name) {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						else
						{
							String query="update login set password=? where username=?";
							  ...
							  if(flag==1)
							  {
								  JOptionPane.showMessageDialog(password_dialog_foruser.this, "password changed!!", "Success", JOptionPane.INFORMATION_MESSAGE);
							   dispose();
